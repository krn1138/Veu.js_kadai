new Vue({
    ...
    methods: {
      ...
      addStudent: function() {
        var xxx = this.students[this.students.length -1].id + 1
        this.students.push({id: this.id, name: this.name, course: this.course, acceptancePeriod: this.acceptancePeriod }) 
